...
class NomorSurat extends BaseController
{
    ...
    // fungsi untuk melihat semua nomor terpakai
    // akses oleh admin departemen dan kepala departemen
    // GET /nomor-surat
    public function index()
    {
        $departemen = session()->get('departemen');
        $semuaNomorSurat = $this->nomorSuratModel->getAllUnionAll($departemen);
        $data = [
            'judul' => 'Daftar Penggunaan Nomor Surat',
            'semuaNomorSurat' => $semuaNomorSurat
        ];

        return view('nomor_surat/v_nomor_surat', $data);
    }

    // fungsi untuk menampilkan form tambah
    // akses oleh mahasiswa
    // GET /nomor-surat/tambah
